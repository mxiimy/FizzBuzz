...
class FizzBuzz {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 1; i < 100; i++) {
            // i++ means increment after the value is used
            // conditions for the for loop are in brackets
            // for loop is contained in {}
            // state the type for each variable
            ...
            // if statements are also contained by () and {}
            // && instead of and 
